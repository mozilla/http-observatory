...
def sanitized_api_response(fn):
    ...
    def wrapper(*args, **kwargs):
        ...
        SCAN_VALID_KEYS = ('end_time', 'error', 'grade', 'hidden', 'likelihood_indicator', 'response_headers',
                           'scan_id', 'score', 'start_time', 'state', 'tests_completed', 'tests_failed',
                           'tests_passed', 'tests_quantity')
